...
def project(context):
    ...
    project.save()
    project.save()
    dictionary = context.dfc.get_all_ancestor_objects( context)
    print(dictionary)
    l0_data = parser.get_sheet("features/fixtures/sample_data.xlsx", "Project")
    l0_datapoint = DataPoint.objects.create(
        custom_field_config=context.dfc.l0, project_data=l0_data[0], created_by=context.user, )
    # l0_dpc = DataPointClassification.objects.create(
    #     l0_id=l0_datapoint.id, data_form_config=context.dfc
    # DataPointClassificationPermission.objects.create(
    #     project=project, data_point_classification=l0_dpc)

    # first_l1_data = parser.get_sheet(
    #     "features/fixtures/sample_data.xlsx", "Sub-project")
    # first_l1_datapoint = DataPoint.objects.create(
    #     custom_field_config=context.dfc.l1, project_data=first_l1_data[0], created_by=context.user)
    # first_l1_dpc = DataPointClassification.objects.create(
    #     parent=l0_dpc, l0_id=l0_datapoint.id, l1_id=first_l1_datapoint.id, data_form_config=context.dfc, created_by=context.user)
    # DataPointClassificationPermission.objects.create(
    #     project=project, data_point_classification=first_l1_dpc)
    ...
    #     custom_field_config=context.dfc.l1, project_data=first_l1_data[0], created_by=context.user)
    # second_l1_dpc = DataPointClassification.objects.create(
    #     parent=l0_dpc, l0_id=l0_datapoint.id, l1_id=second_l1_datapoint.id, data_form_config=context.dfc, created_by=context.user)
    # DataPointClassificationPermission.objects.create(
    #     project=project, data_point_classification=second_l1_dpc)
    ...
    #         custom_field_config=context.dfc.l2, project_data=assay_def[0], created_by=context.user)
    #     assay_def_dpc = DataPointClassification.objects.create(
    #         parent=parent, l0_id=l0_datapoint.id, l2_id=assay_def_dp.id, l1_id=first_l1_datapoint.id, data_form_config=context.dfc, created_by=context.user)
    #     DataPointClassificationPermission.objects.create(
    ...
    #             created_by=context.user)
    #         DataPointClassificationPermission.objects.create(
    #             project=project, data_point_classification=activity_dpc)
