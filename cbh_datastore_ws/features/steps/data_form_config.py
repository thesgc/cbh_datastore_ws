...
def step(context):
    ...
    context.test_case.assertEquals(data["objects"][0]["data_form_configs"][0]["last_level"], "l0")
    context.test_case.assertEquals(data["objects"][0]["data_form_configs"][0]["permitted_children"],["/dev/datastore/cbh_data_form_config/7"])
